    ...
    while (ligne < nombreDeLignes) {
        ...
        while (i < MAXIMUM_ENVAHISSEURS_PAR_LIGNE) {
            ...
            envahisseurs.push({
                ...
                couleur: estEnvahisseurRapideHorizontal ? (etroit ? (estEnvahisseurRapideVertical ? "#ffb6c1": "#dda0dd") : (estEnvahisseurRapideVertical ? "#fa8072" : "#ffc0cb")) :
                                                          (etroit ? (estEnvahisseurRapideVertical ? "#ffdab9": "#bc8f8f") : (estEnvahisseurRapideVertical ? "#f08080" : "#eee8aa")),
