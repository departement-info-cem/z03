// =========== DÉMARRAGE DU JEU ===========
//TROIS MODS:
// MOD 1 : augmentation du nombre de tir par seconde selon le score (ligne 614 script.js)
// MOD 2 : 2 laser (ligne 241 script.js)
// MOD 3 : changer l'image de fond (css background image)
// ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
// TOUDOU 01
...
function dessinerEnvahisseurs() {
    ...
    // ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
    // Boucle
    for(let méchant of envahisseurs){
        ...
        // ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
        //VOTRE CODE ICI
        dessinerObjet(méchant.x, méchant.y, méchant.largeur, méchant.hauteur, méchant.couleur);
...
function creerTir() {
    ...
    if (etatTouches.tir && momentActuel - gMomentDernierTir >= gIntervalleEntreTirs) {
        ...
        tirs.push({
            x: joueur.x + joueur.largeur / 1 - TIR_LARGEUR / 2, // Positionnez le tir au milieu horizontalement du joueur.
        ...
        tirs.push({
            x: joueur.x +2 * joueur.largeur  /30   - TIR_LARGEUR / 50 ,
            y: joueur.y,
...
if(gScore>=500 && gScore<750){
    
    gIntervalleEntreTirs = 100
}

if(gScore>=1000 && gScore<1300){
    
    gIntervalleEntreTirs = 100
}

if(gScore>=1600 && gScore<2000){
    
    gIntervalleEntreTirs = 110
}
}
