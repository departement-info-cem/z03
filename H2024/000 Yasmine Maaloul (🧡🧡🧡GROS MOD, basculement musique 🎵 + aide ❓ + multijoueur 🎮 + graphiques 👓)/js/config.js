...
const POSITION_DEPART_X_JOUEUR1 = ZoneDeJeu.width / 4;
const COULEUR_JOUEUR = "#0000ff";
const joueur1 = {
    x: POSITION_DEPART_X_JOUEUR1,
    y: ZoneDeJeu.height - 70,
    largeur: 80,
    hauteur: 70,
    vitesseDeplacement: 10
};
const POSITION_DEPART_X_JOUEUR2 = (3 * ZoneDeJeu.width) / 4;
const COULEUR_JOUEUR2 = "#ff0000"; 

const joueur2 = {
    x: POSITION_DEPART_X_JOUEUR2,
    y: ZoneDeJeu.height - 70,
    largeur: 80,
    hauteur: 70,
    vitesseDeplacement: 10
...
const COULEUR_TIR = "#F415AB"; // Couleur des tirs, ici un vert vif.
...
const VITESSE_Y_MINIMALE = 0.15; // Vitesse minimale sur l'axe Y pour les envahisseurs, détermine la vitesse de descente.
...
const VITESSE_HORIZONTALE = 0.10; // Vitesse horizontale de base pour les envahisseurs rapides.
