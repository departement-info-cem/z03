...
document.querySelector("#rapidfire").addEventListener("click", rapidfire);

document.querySelector("#easymode").addEventListener("click", easymode);

document.querySelector("#nightmare").addEventListener("click", nightmare);

function rapidfire() {
    VITESSE_DEPLACEMENT_TIR = -45;
}
...
function nightmare() {
    VITESSE_Y_MINIMALE = 0.16;
    NB_ENVAHISSEURS_PAR_VAGUE = 9;
}
// =========== LOGIQUE DU JEU ===========
...
function verifierFinDuJeu(envahisseurs) {
    ...
    while (indexEnvahisseur < envahisseurs.length) {
        ...
        // ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄    
        //VOTRE CODE ICI
        let envahisseur = indexEnvahisseur;
        ...
        //SI (condition)
        if ((envahisseurs[indexEnvahisseur].y + envahisseurs[indexEnvahisseur].hauteur) >= ZoneDeJeu.height) {
