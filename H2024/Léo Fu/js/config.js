...
VITESSE_DEPLACEMENT_TIR = -5; // Vitesse de déplacement des tirs sur l'axe Y; une valeur négative indique un mouvement vers le haut.
const COULEUR_TIR = "#00ff00"; // Couleur des tirs, ici un vert vif.
TIR_LARGEUR = 5; // Largeur des tirs 
TIR_HAUTEUR = 25; // Hauteur des tirs 
...
NB_ENVAHISSEURS_PAR_VAGUE = 5; // Nombre d'envahisseurs à générer par vague.
VITESSE_Y_MINIMALE = 0.11; // Vitesse minimale sur l'axe Y pour les envahisseurs, détermine la vitesse de descente.
