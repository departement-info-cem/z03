...
const tirs2 = [];
const INTERVAL_TIR_DEPART2 = 400;
const VITESSE_DEPLACEMENT_TIR2 = -5;
const COULEUR_TIR2 = "#ffaa00";
const TIR_LARGEUR2=5;
const TIR_HAUTEUR2=25;
