...
let INTERVAL_TIR_DEPART = 400; // Intervalle de temps de départ en millisecondes entre les tirs successifs.
const VITESSE_DEPLACEMENT_TIR = -10; // Vitesse de déplacement des tirs sur l'axe Y; une valeur négative indique un mouvement vers le haut.
...
const VITESSE_Y_MINIMALE = 0.3; // Vitesse minimale sur l'axe Y pour les envahisseurs, détermine la vitesse de descente.
