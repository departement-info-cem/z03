...
// VOTRE CODE ICI :
   ...
   img = new Image();
   img.src = "images/Cupidon.png";
   img2 = new Image(); 
   img2.src = "images/amour.png";
   img3 = new Image();
   img3.src = "images/coeur.png"; 
...
function miseAJourEnvahisseurs() {
    ...
    while (indexEnvahisseur < envahisseurs.length) {
        ...
        if (envahisseurs.length == 1) {
            envahisseur.vitesseVerticale = 3; }
...
function dessinerJoueur() {
    ...
    // ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
    //VOTRE CODE ICI
    contexteZone.drawImage(img,joueur.x,joueur.y,joueur.largeur, joueur.hauteur );
...
function dessinerEnvahisseurs() {
    ...
    // Boucle 
        ...
        //dessinerObjet(envahisseur.x , envahisseur.y , envahisseur.largeur , envahisseur.hauteur , envahisseur.couleur); 
            contexteZone.drawImage(img2,envahisseur.x , envahisseur.y , envahisseur.largeur , envahisseur.hauteur);
...
function dessinerTirs() {
    ...
    while (indexTir < tirs.length) {
        ...
        contexteZone.drawImage(img3, tir.x, tir.y, tir.largeur, tir.hauteur);
...
function gererTirs() {
    ...
    while (i >= 0) {
        ...
        // ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
        //VOTRE CODE ICI
        tirs[i].y = tirs[i].y + tirs[i].vitesseVerticale; 
