...
const COULEUR_TIR = "#ff0000"; // Couleur des tirs, ici un vert vif.
const TIR_LARGEUR=25; // Largeur des tirs 
...
const HAUTEUR_ENVAHISSEUR = 60; // Hauteur standard pour tous les envahisseurs.
